...
$KENLM_ROOT/lmplz -o 4 -S 40% -T ~/tmp < $target_dir/lm.upper.lid.txt --discount_fallback --prune 0 0 0 3 >| $target_dir/kenlm.wrd.o40003.arpa
...
$KENLM_ROOT/lmplz -o 4 -S 40% -T ~/tmp < $target_dir/phones/lm.phones.filtered.txt --discount_fallback >| $target_dir/phones/lm.phones.filtered.04.arpa
$KENLM_ROOT/build_binary $target_dir/phones/lm.phones.filtered.04.arpa $target_dir/phones/lm.phones.filtered.04.bin
$KENLM_ROOT/lmplz -o 6 -S 40% -T ~/tmp < $target_dir/phones/lm.phones.filtered.txt --discount_fallback >| $target_dir/phones/lm.phones.filtered.06.arpa
